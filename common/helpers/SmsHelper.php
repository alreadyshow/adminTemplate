...
class SmsHelper
{
     ...
     * @return String
     */
    protected function curl_post($url, $header, $content)
    {
        \Yii::info($url, 'backend\send');
        \Yii::info($content, 'backend\send');
        $ch = curl_init();
        ...
        \Yii::info($response, 'backend\send');
        // 查看请求头信息
     ...
     * @return String
     */
    public function message($mobile, $templateid)
    {
