...
class DbLogTarget extends Target
{
    ...
    public function export()
    {
        ...
        $sql = "INSERT INTO $tableName ([[log_type]],[[level]], [[category]], [[log_time]], [[prefix]], [[message]])
                VALUES (:cate,:level, :category, :log_time, :prefix, :message)";
    ...
    public function getMessagePrefix($message)
    {
        ...
        return "[$ip][ID:$userID 用户名: $username]";
    }
}
